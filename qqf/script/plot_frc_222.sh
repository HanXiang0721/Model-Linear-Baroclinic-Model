...
HAMP2=$(grep "hamp2" ./mk_2frc_bs2.sh | awk -F = '{print $2}' | head -n 1)
XDIL2=$(grep "xdil2" ./mk_2frc_bs2.sh | awk -F = '{print $2}' | head -n 1)
YDIL2=$(grep "ydil2" ./mk_2frc_bs2.sh | awk -F = '{print $2}' | head -n 1)
XCNT2=$(grep "xcnt2" ./mk_2frc_bs2.sh | awk -F = '{print $2}' | head -n 1)
YCNT2=$(grep "ycnt2" ./mk_2frc_bs2.sh | awk -F = '{print $2}' | head -n 1)

VAMP2=$(grep "vamp2" ./mk_2frc_bs2.sh | awk -F = '{print $2}' | head -n 1)
VCNT2=$(grep "vcnt2" ./mk_2frc_bs2.sh | awk -F = '{print $2}' | head -n 1)
VDIL2=$(grep "vdil2" ./mk_2frc_bs2.sh | awk -F = '{print $2}' | head -n 1)
