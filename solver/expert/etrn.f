      PROGRAM ETRN
*
*     derived from solver/trnpw.f on 2000/04/24
...
*
      ...
      PARAMETER( MAXN=2*NMAX*(3*KMAX+1) )
...
*     [work]
      ...
      SAVE        GPS, GQ
      SAVE        NMO, EDEL, SALPHA, SBETA, ALAT, SIG, SIGM
*
...
*     namelist variables
*
      CHARACTER*90 CFM          !! input file name (unused)
...
* 
     ...
     I                   G2, IDIM*JMAX*KMAX )
               ...
               DO 600 L = 1, ( M4-1 ) * ( ( MVAR+1 ) * KMAX + 1 ) !! read dummy
                  READ( IFG ) ((GO(I,J),I=1,IIMAX),J=1,JMAX)
 600           CONTINUE
...
*     log
*
         WRITE( NOUT, *) '# mode:',M1,' check count:',ICHK
*
 300  CONTINUE
      CLOSE( IFS )
      CLOSE( IFG )
