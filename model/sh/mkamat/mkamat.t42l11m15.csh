...
cat << END_OF_DATA >>! $DIR/out/SYSIN
 ...
 &nmdamp ddragv=1.,2.,3.,15.,-1.,-1.,-1.,-1.,-1.,-1.,5.,
         ddragd=1.,2.,3.,15.,-1.,-1.,-1.,-1.,-1.,-1.,5.,
         ddragt=1.,2.,3.,15.,-1.,-1.,-1.,-1.,-1.,-1.,-1.,
         ddragq=1.,2.,3.,15.,-1.,-1.,-1.,-1.,-1.,-1.,-1.,
         tunit='DAY'                                           &end
 ...
 &nmmca ttau0=3, qtau0=3, ttauc=6., tunit='HOUR', 
        sigkb=0.95D0, thcape=3.5d3, ocef=t, cefmx=0.9          &end
 &nmsfcm expw=0.5, dlnd=5., owes=t, zsth=1.d2                  &end
...
cat << END_OF_DATA3 >>! SETPAR
 &nmfin cfm='/home/q16655/ln_solver/matrix.moi/mat/$MATFIL',
        cfr='/home/q16655/ln_solver/data/couple/frc/frc.t42l11.mat',
        cfs='/home/q16655/ln_solver/matrix.moi/mat/$MATIFIL',
        cfg='/home/q16655/ln_solver/data/couple/rsp/rsp.t42l11m15.grd'
 &end
 &nmall owall=f
 &end
 &nmcls oclassic=f
