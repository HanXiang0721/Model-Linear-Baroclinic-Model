#!/bin/csh -f
#
#      making linear matrix for T21L20 LBM/PWM 
#
...
setenv RUN      $LBMDIR/bin/$SYSTEM/lbm2.t21ml20cmkamat # Excutable file
setenv DATZ                                            # Topography Data
setenv DIR      $LNHOME/matrix                         # Directory for Output
setenv INITFILE $LNHOME/bs/gt3/ncepwin.t21l20zm        # Atm. BS File
...
cat << END_OF_DATA >>! $DIR/out/SYSIN
 ...
 &nmdamp ddragv=2.,2.,2.,2.,4.,10.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,4.,4.,
         ddragd=2.,2.,2.,2.,4.,10.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,4.,4.,
         ddragt=2.,2.,2.,2.,4.,10.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,20.,4.,4.,
         tunit='DAY'                                           &end
