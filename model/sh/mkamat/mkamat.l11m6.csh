...
#
#setenv DATS     $LNHOME/data/couple/bs/gt3/sstfeb.t21     # mean SST
#setenv DATW     $LNHOME/data/couple/bs/gt3/wgfeb.t21      # soil wetness
#setenv BSFILE   $LNHOME/data/couple/bs/gt3/ncepfeb.t21l11 # Atm. BS File
#
#setenv DATS     $LNHOME/data/couple/bs/gt3/sstmar.t21     # mean SST
#setenv DATW     $LNHOME/data/couple/bs/gt3/wgmar.t21      # soil wetness
#setenv BSFILE   $LNHOME/data/couple/bs/gt3/ncepmar.t21l11 # Atm. BS File
#
...
cat << END_OF_DATA >>! $DIR/out/SYSIN
 ...
 &nmdamp ddragv=1.5,1.5,3.,10.,20.,50.,50.,50.,50.,2.,2.,
         ddragd=1.5,1.5,3.,10.,20.,50.,50.,50.,50.,2.,2.,
         ddragt=1.5,1.5,3.,10.,20.,50.,50.,50.,50.,2.,2.,
         ddragq=1.5,1.5,3.,10.,20.,50.,50.,50.,50.,2.,2.,
         tunit='DAY'                                           &end
