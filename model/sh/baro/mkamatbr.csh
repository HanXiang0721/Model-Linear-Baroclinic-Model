...
setenv RUN      $LBMDIR/bin/$SYSTEM/lbm2.t21ml1cbaro   # Excutable file
setenv DIR      $LNHOME/matrix                         # Output Dir
setenv BSFILE   $LNHOME/bs/gt3/ncepwin.t21l1           # Atm. BS File
#setenv BSFILE   $LNHOME/bs/gt3/ncepwin.t21l1.35        # Atm. BS File
#setenv BSFILE   $LNHOME/bs/gt3/ncepwin.t21l1.51        # Atm. BS File
#setenv BSFILE   $LNHOME/bs/gt3/ncepwin.t21l1zm        # Atm. BS File
#setenv BSFILE   $LNHOME/bs/gt3/idealwin.t21l1zm        # Atm. BS File
setenv MATDIR   $DIR/mat                               # matrix directory
setenv MATNAM   MATBR.ncepwin.dat                      # matrix file name
#setenv MATNAM   MATBR.idealwin.dat                      # matrix file name
#setenv MATNAM   MATPWMBR.ncepwin.dat                   # matrix file name
#
# T21 L1
#
