* obtained from ncepbrbs.f on 2001/06/19
* basic state
* derived from winter 300hPa stream function in NCEP reanalysis
DSET ^ncepwin.t21l1zm.grd
* BYTESWAPPED
